 ...
 * makes the gap HARDER to spot, not easier: GA4 shows revenue with no funnel
 * above it.
 *
 ...
 * FunnelTracker's effect, which runs after hydration. lib/ga4.ts queues onto
 * dataLayer when gtag has not arrived yet, so that race loses nothing.
 */
