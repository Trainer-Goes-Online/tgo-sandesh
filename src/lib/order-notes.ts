 ...
 * page.
 *
 * The layout is five READABLE keys, for whoever opens the payment in the
 ...
 * into 256-character pieces. 2,560 characters of carrier against a worst case
 * near 1,600 once every field is at its cap, so there is real headroom rather
 * than a single spare slot.
 *
...
/* Per-field caps applied BEFORE serialising. Chosen from real values: a user
   agent is typically 110-180 chars, a landing url with campaign params
   200-400, an fbclid 90-160. Anything over its cap is truncated rather than
