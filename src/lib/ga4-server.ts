 ...
 *
 * A browser-side purchase only counts buyers who return to the page. In India
 * most of them do not: a UPI payer completes inside their bank app and may
 * never come back to the tab. That is the same reason Meta's Purchase is sent
 * from the Razorpay webhook, and this closes the equivalent hole in GA4 so the
