 ...
 * arrived with an fbclid, so it is synthesised from the URL on first landing,
 * exactly as Meta's own pixel would.
 */

import { readAttribution } from "@/lib/attribution";

const EXTERNAL_ID_KEY = "eon_external_id";
 ...
 * them. Every paid sale would then be written to the order with blank UTMs.
 */
